 ...
 * This is the primary interface for the program. DO NOT MODIFY THIS FILE.
 ...
 * should be applied to the results of the minPlayers filter unless reset is called in between.
 */
public interface IPlanner {
     ...
     * Column names will match the values in GameData. As such it is possible to use
